...
import { ENUM_BillPaymentMode, ENUM_BillingStatus, ENUM_BillingType, ENUM_DanpheHTTPResponses, ENUM_InvoiceType, ENUM_ServiceBillingContext } from '../../shared/shared-enums';
...
export class BillingTransactionItemComponent {
  ...
  public GetVisitContext(patientId: number, patientVisitId: number): void {
    if (patientId && patientVisitId) {
      this.BillingBLService.GetDataOfInPatient(patientId, patientVisitId)
        .subscribe(res => {
