...
export class ReceiptPrintMainComponent implements OnInit {
  ...
  constructor(
    ...
    //this.BackButton._hash = ('/Billing/ReceiptPrint');
    //this.BackButton._hash = null;
    //this.BackButton._hash = ('/Billing/ReceiptPrint');
    ...
    else if (this.billingReceipt.ReceiptType == "ip-receipt" && this.billingService.ShowIPBillSeparately()) {
