...
export class VitalsListComponent {
    ...
    constructor(public visitService: VisitService,
        ...
        public patientService: PatientService, public coreService: CoreService) {
    ...
    AssignDoctorsPanel() {
        ...
        if (currProviderId == 110 || currProviderId == 112 || currProviderId == 140) {
            this.doctorsPanel = ["Prof. Dr. Padam Raj Pant","Dr. Sunita Pun","Dr. Atit Poudel"];
        }
        else {
