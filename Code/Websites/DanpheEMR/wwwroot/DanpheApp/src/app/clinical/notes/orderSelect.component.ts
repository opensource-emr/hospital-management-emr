...
export class SelectOrderComponent {  
    ...
    Close() {
        ...
        this.ordersEmitter.emit({ allorders: null, displayProp: false, submit: false });  
    }
    ...
    SubmitOrders() {
        ...
        this.ordersEmitter.emit({ allorders: this.allOrderList, displayProp: false, submit: true }); 
