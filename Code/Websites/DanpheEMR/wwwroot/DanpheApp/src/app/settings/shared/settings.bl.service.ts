...
import { BedFeaturesMap } from '../../admission/shared/bedfeature-map.model';
...
export class SettingsBLService {
  ...
  public GetAutoBillingItemList() {
    return this.settingsDLService.GetAutoBillingItemList()
      .map(res => { return res });
  }
  ...
  public PostParameterValue() {
    return this.settingsDLService.Postparametervalue()
      .map(res => { return res });
  }
  ...
  public GetIntegrationNamee() {
    return this.settingsDLService.GetIntegrationName()
      .map(res => { return res });
  }
  ...
  public AddRolePermissions(rolePermissions: Array<RolePermissionMap>) {
    return this.settingsDLService.PostRolePermissions(rolePermissions)
      .map(res => { return res });
  }
