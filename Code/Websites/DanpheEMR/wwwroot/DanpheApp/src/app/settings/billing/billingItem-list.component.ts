...
@Component({
    ...
    templateUrl: './billingItem-list.html',
})
export class BillingItemListComponent {
    public billingItemList: Array<BillingItem> = new Array<BillingItem>();
    ...
    ActivateDeactivateBillItem(currBillItem: BillingItem) {
    ...
    ShowPriceChangeHistory(billItem: BillingItem) {
        if (billItem != null) {
            this.selectedItem = null;
