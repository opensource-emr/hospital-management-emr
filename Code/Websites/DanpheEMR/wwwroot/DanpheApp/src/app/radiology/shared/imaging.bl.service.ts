...
export class ImagingBLService {
    ...
    public GetImagingReqsAndReportsByStatus() {
        var reqOrderStatus = "active";
        var reportOrderStatus = "pending";
        var billingStatus = "paid";
        return this.imagingDLService.GetImagingReqsAndReportsByStatus(reqOrderStatus, reportOrderStatus, billingStatus)
            .map(res => { return res });
    }
    ...
    //imaging-result.component
    //gets reports of selected patient
    public GetAllImagingReports(frmDate, toDate) {
        var reportOrderStatus: string = "final";
        return this.imagingDLService.GetAllImagingReports(reportOrderStatus, frmDate, toDate)
            .map(res => { return res });
    }
    ...
    //imaging-report.component
    //post report 
    public AddImgItemReport(filesToUpload, imgReport: ImagingItemReport, orderStatus: string) {
        try {
