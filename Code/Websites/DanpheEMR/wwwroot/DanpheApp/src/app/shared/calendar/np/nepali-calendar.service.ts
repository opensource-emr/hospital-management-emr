...
export class NepaliCalendarService {
    ...
    public yr_mth: Array<Array<number>>;
    public nep_mth_Dates: Array<number>;

    public minNepYear: number = 1970;
    public maxNepYear: number = 2090;

    public minEngYear: number = 0;
    public maxEngYear: number = 0;
    ...
    LoadNepYear_MthHash() {
        ...
        this.yr_mth[1998] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];//days are corrected in this year: sud:15Mar'19
        this.yr_mth[1999] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];//days are corrected in this year: sud:15Mar'19
    ...
    public ConvertEngToNepaliFormatted(engDate: string = null, format: string):string {
        ...
        if (format = 'DD')
            return npDate.Day.toString();
        else if (format = 'MM')
            return npDate.Month.toString();
        else if (format = 'YYYY')
    ...
    public GetEngCalendarYearInfo(): Array<any> {
        let engYearsHash = [
