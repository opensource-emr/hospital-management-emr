   ...
   // public Date: Date = null;
    ...
    public IsDirty(fieldName): boolean {
        if (fieldName == undefined)
            return this.TotalAdmittedPatientValidator.dirty;
        else
            return this.TotalAdmittedPatientValidator.controls[fieldName].dirty;
    }

    public IsValid():boolean{if(this.TotalAdmittedPatientValidator.valid){return true;}else{return false;}} public IsValidCheck(fieldName, validator): boolean {
        if (fieldName == undefined)
            return this.TotalAdmittedPatientValidator.valid;
        else
