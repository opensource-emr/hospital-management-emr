...
export class NursingIpBillItemRequestComponent{
    ...
    ngOnInit() {
        ...
        this.billItems = this.billItems.filter(val => val.ServiceDepartmentName != "EMERGENCY");
    ...
    public PostToDepartmentRequisition() {
        ...
        this.billingBLService.PostDepartmentOrders(this.billingTransaction.BillingTransactionItems, "active", "provisional",false, this.currPatVisitContext)//fasle value is making InsuranceApplicableItem =false in lab requition table
            .subscribe(res => {
                if (res.Status == "OK") {
