...
@Component({
    templateUrl: "../../view/admission-view/AdmittedList.html" // "/AdmissionView/AdmittedList"
})
...
export class AdmittedListComponent {
    ...
    public selectedBedInfo: { PatientAdmissionId, PatientId, PatientVisitId, MSIPAddressInfo, PatientCode, DischargedDate, Name, BedInformation: { BedId, PatientBedInfoId, Ward, BedFeature, BedCode, BedNumber, BedFeatureId, AdmittedDate, StartedOn } };
    ...
    public GetSimilarBedFeatures() {
        this.admissionBLService.GetSimilarBedFeatures(this.selectedBedInfo.BedInformation.BedId, this.selectedBedInfo.BedInformation.BedFeatureId)
            .subscribe(res => {
                if (res.Status == 'OK') {
