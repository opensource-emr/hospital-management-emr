...
export class LabsDLService {
    ...
    public GetLatestSampleCode(visitType: string, sampleDate: string, runNumberType: string) {
        return this.http.get<any>("/api/Lab?reqType=latest-samplecode&visitType=" + visitType + '&SampleDate=' + sampleDate + '&runNumberType=' + runNumberType, this.options)
    }
    ...
    public GetLabTestPendingReports() {
        return this.http.get<any>("/api/Lab?&reqType=pending-reports", this.options)
    }
    public GetLabTestFinalReports(frmdate,todate) {
        return this.http.get<any>("/api/Lab?reqType=final-reports&FromDate=" + frmdate + "&ToDate=" + todate, this.options)
    ...
    public GetTestListOfSelectedInPatient(patId: number, patVisitId: number) {
        return this.http.get<any>("/api/Lab?reqType=labTestListOfSelectedInpatient&patientId=" + patId + "&patientVisitId=" + patVisitId, this.options)
    }
    ...
    public UpdateIsPrintedFlag(reportId: number) {
        return this.http.put<any>("/api/Lab?reqType=update-reportPrintedFlag&reportId=" + reportId, this.options);
    }
