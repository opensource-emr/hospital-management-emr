...
@Component({
    ...
    templateUrl: "../../view/inventory-view/RequisitionItems.html"  // "/InventoryView/RequisitionItems"
...
export class RequisitionItemsComponent {
  ...
  DirectDispatch() {
      ...
      this.inventoryBLService.PostToRequisition(this.requisition).
        subscribe(res => {
          if (res.Status == 'OK') {
            ...
            this.inventoryService.Name = this.department.find(a => a.DepartmentId == this.requisition.DepartmentId).DepartmentName;
            ////deleting all creating new requisition..after successully adding to db
            this.requisition.RequisitionItems = new Array<RequisitionItems>();
            this.requisition = new Requisition();
            this.currentRequItem = new RequisitionItems();
        ...
        this.inventoryBLService.GetDepartmentDetailByRequisitionId(data).
            subscribe(res => {
                if (res.Status == 'OK') {
                    ...
                    this.router.navigate(['/Inventory/InternalMain/RequisitionDetails']);
                }
                else {
    ...
    GetDepartment(): void {
        ...
        //     },
        //         err => {
        //             this.messageBoxService.showMessage("error", ["failed to get department"]);
