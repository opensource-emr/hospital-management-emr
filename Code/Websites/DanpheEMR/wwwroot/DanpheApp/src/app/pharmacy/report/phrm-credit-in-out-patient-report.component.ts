...
@Component({
    selector: 'my-app',
    templateUrl: "../../view/pharmacy-view/Report/PHRMCreditInOutPatient.html" //"/PharmacyReport/PHRMCreditInOutPatient"
})
export class PHRMCreditInOutPatientReportComponent {
    ...
    constructor(public pharmacyBLService: PharmacyBLService, public dlService: DLService,
        ...
        this.patientType = "in"; ///by default patient Type is In 
    }
