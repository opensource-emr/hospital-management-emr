...
@Component({
    selector: 'my-app',
    templateUrl: "../../view/pharmacy-view/Report/PHRMABCVEDReport.html" //"/PharmacyView/PHRMABCVEDReport"
})
export class PHRMABCVEDReportComponent {
  ...
  constructor(public pharmacyBLService: PharmacyBLService, public dlService: DLService, public msgBoxServ: MessageboxService) {
    ...
    OnGridExport($event: GridEmitModel) {
        this.dlService.ReadExcel("/PharmacyReport/ExportToExcelPHRMABCVEDStockReport?Status=" + this.Status)
            .map(res => res)
            .subscribe(data => {
                let blob = data;
