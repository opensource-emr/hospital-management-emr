...
export class DashboardHomeComponent {
    ...
    LoadDepartmentAppts() {
        this.dlService.Read("/Reporting/DepartmentAppointmentsTotal")
            .map(res => res)
            .subscribe(res => {
                //console.log("---start: DepartmentAppointmentsTotal-----");
                //console.log(res);
                //console.log("---end: DepartmentAppointmentsTotal-----");
                let dataToParse: Array<any> = JSON.parse(res.Results.JsonData);
                ...
                //this.danpheCharts.Billing_Mix_MonthlyBilling("dvMonthlyBilling", dataToParse);
                //"[{"DepartmentName":"Emergency","AppointmentCount":1},{"DepartmentName":"Human Resource","AppointmentCount":1},{"DepartmentName":"Internal Medicine","AppointmentCount":4},{"DepartmentName":"Laboratory","AppointmentCount":2},{"DepartmentName":"Neurology","AppointmentCount":9},{"DepartmentName":"Surgery","AppointmentCount":2}]"
                //console.log("----LoadDepartmentAppts----");
                //console.log(res);
                //{ "department": "Internal Medicine", "apptCount": 501 }
            },
            err => {
                alert(err.ErrorMessage);
